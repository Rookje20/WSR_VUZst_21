...
--
-- Table structure for table `lerning_record`
--

DROP TABLE IF EXISTS `lerning_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lerning_record` (
  `idlerning_record` int NOT NULL,
  `idstart` int NOT NULL,
  `time_run` time NOT NULL,
  PRIMARY KEY (`idlerning_record`),
  KEY `startt_idx` (`idstart`),
  CONSTRAINT `startt` FOREIGN KEY (`idstart`) REFERENCES `start` (`idstart`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lerning_record`
--

LOCK TABLES `lerning_record` WRITE;
/*!40000 ALTER TABLE `lerning_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `lerning_record` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-26 12:21:45
